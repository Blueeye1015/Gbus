          ...
          switch ($this->getRequest('event')) {
            ...
            case "CLICK":
              switch ($this->getRequest('EventKey')) {
                case 'ABOUT_US':
                  $this->responseText('我们是一群怀揣梦想，受够了整天挤着公交，搭着地铁，烧着汽油上下班的年轻人。于是，我们开始了我们的创业之旅，12天完成首轮融资，以后的事我们不去预测，我们只相信做好了，用心做了就一定会被公众认可就会被“天使”青睐！联系电话：62606678');
                  break;
                case 'HUODONG':
	              $this->responseText('吉巴士免费送话费啦！您可发送“充值+运营商+手机号”给我们，就有机会获得100元话费噢！');
                  break;
                case 'GSTORE':
                  $this->responseText('吉商城即将上线，敬请期待！');
	              break;
                default:
